...
{
    internal class ToChangeTheDesiredProjectNameToANewNameWhichHasAlreadyBeenReservedForAnotherProject
    {
        private readonly IProjectService _service;
        private ChangeTheProjectName? _request = null;
        private Func<Task>? _actual = null;

        internal ToChangeTheDesiredProjectNameToANewNameWhichHasAlreadyBeenReservedForAnotherProject(IServiceScope scope)
        {
