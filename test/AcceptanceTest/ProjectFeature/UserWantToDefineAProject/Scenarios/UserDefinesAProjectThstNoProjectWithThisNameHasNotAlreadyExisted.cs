...
{
    internal class UserDefinesAProjectThstNoProjectWithThisNameHasNotAlreadyExisted
    {
        private readonly IProjectService _service;
        private DefineAProject? _request = null;
        private Func<Task>? _actual = null;

        internal UserDefinesAProjectThstNoProjectWithThisNameHasNotAlreadyExisted(IServiceScope serviceScope)
        {
